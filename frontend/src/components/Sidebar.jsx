...
import { BellIcon, Donut, HomeIcon, UserIcon } from 'lucide-react'
...
const Sidebar = () => {
  ...
  return (
    <aside className='w-64 bg-base-200 border-r border-base-300 hideen lg:flex flex-col h-screen sticky top-0'>
